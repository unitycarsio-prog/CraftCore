...
export const CraftCoreLogoIcon: React.FC<IconProps> = (props) => (
...
export const RocketIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.1S5.34 15.79 4.5 16.5Z" />
...
export const FileArchiveIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M16 22H8a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8"/>
        <path d="M18 4H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V6l-4-4Z"/>
        <path d="M14 2v4h4"/>
        <path d="M8 12h8"/>
        <path d="M8 16h8"/>
    </svg>
...
export const RestoreIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M3 2v6h6"/>
        <path d="M21.188 8.018a9.94 9.94 0 0 0-4.29-4.29 9.97 9.97 0 0 0-14.876 5.21"/>
    </svg>
);
