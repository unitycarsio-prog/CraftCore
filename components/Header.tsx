...
const NavLink: React.FC<{
  ...
  return (
    <button
      ...
      className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-300 transform hover:scale-105 active:scale-100 ${
        isActive
    ...
    <header className="bg-slate-900/70 backdrop-blur-lg sticky top-0 z-50 border-b border-slate-800">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-3 cursor-pointer animate-fadeInUp" onClick={() => onNavigate(Page.HOME)}>
          ...
          <nav className="flex items-center space-x-2 p-1 bg-slate-800 rounded-lg animate-fadeInUp" style={{ animationDelay: '150ms' }}>
